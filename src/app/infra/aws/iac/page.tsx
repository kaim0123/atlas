...
export default function Page() {
  return (
    <DocsPage>
      ...
      <p>これでAWSの基礎から、インフラを実際に定義してデプロイする層までを一通り見たことになります。手を動かして構築する際は、<Link href="/infra/aws/basics">AWSの基礎</Link>で見たリージョン・AZの構造を踏まえながら、まずはL2 Constructから書き始めるのが定石です。</p>

      <RelatedNav>
        <RelatedList>
          <RelatedLink href="/infra/aws/cicd/codepipeline" tag="AWS">CodePipeline</RelatedLink>
          <RelatedLink href="/infra/aws/compute/lambda" tag="AWS">Lambda</RelatedLink>
