...
export default function Page() {
  return (
    <DocsPage>
      ...
      <p>保管される秘密の値は<Link href="/infra/aws/security">KMS</Link>によって暗号化された状態でディスクに保存され、アプリケーションがAPI経由で取得するときだけ復号されます。秘密の値そのものをコードやコンテナイメージ、環境変数に直接埋め込む必要がなくなり、コードリポジトリへの誤コミットのようなうっかりミスによる漏洩リスクを減らせます。</p>
