...
export default function Page() {
  return (
    <DocsPage>
      ...
      <p><Link href="/computer/os/linux">Linuxの歴史</Link>や<Link href="/computer/os/unix">UNIXの歴史と哲学</Link>を追うと、必ず「GNU」という名前が顔を出します。このページでは、リチャード・ストールマン(RMS)が始めた<Term>GNUプロジェクト</Term>と、その自由を永続的に守ってきた<Term>コピーレフト(GPL)</Term>という発明を見ていきます。核心は一貫してこうです ― <strong>フリーとは、無料のことではなく、自由のことである</strong>。</p>
      ...
      <DocsFooter>Atlas &middot; コンピュータ &middot; GNUとフリーソフトウェア</DocsFooter>
    </DocsPage>
  );
}
