...
export default function Page() {
  return (
    <DocsPage>
      ...
      <p><Link href="/computer/os/unix">UNIXの歴史と哲学</Link>で見たように、現代の主要OSの多くはUNIXの系譜に属します。ただし「UNIX系」とひとくくりにされるものの中身は一枚岩ではありません。ここでは、そっくりに見える3つのファミリーが「どこが同じで、どこが違うのか」を、共通基盤であるPOSIXを軸に整理します。</p>
      ...
      <p>過去に Inspur K-UX がLinux環境でPOSIX認定を取得した例はありますが、一般的なUbuntuやFedoraは認定なしです。実用上はほぼ問題ありませんが、厳密には「UNIX系OS」「UNIX-like OS」と呼ぶのが正確です。GNUという土台については<Link href="/computer/os/gnu">GNUとフリーソフトウェア</Link>で詳しく扱います。</p>
      ...
      <DocsFooter>Atlas &middot; コンピュータ &middot; UNIX・BSD・Linuxの違い</DocsFooter>
    </DocsPage>
  );
}
