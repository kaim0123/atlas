...
export default function Page() {
  return (
    <DocsPage>
      ...
      <p>「システムが正常に動いているか」は、役割の異なる3種類のデータから判断します。この分類はAWSのCloudWatchで見た構成と同じで、クラウド事業者を問わない一般的な考え方です(AWS固有の実装は<Link href="/infra/aws/monitoring">モニタリングと管理</Link>を参照)。</p>
      ...
      <DocsFooter>Atlas &middot; 運用 &middot; 監視・保守</DocsFooter>
    </DocsPage>
  );
}
