...
export default function Page() {
  return (
    <DocsPage>
      ...
      <Aside label="つながり">
        「頻度の高い記号に短い符号を割り当てる」という発想は、文字を効率よくバイト列にする仕組みにも通じます。文字コードは「<Link href="/theory/encoding">文字コード</Link>」で扱っています。また、通信路での誤り検出・訂正の実装側は「<Link href="/network/protocols">通信プロトコル</Link>」を参照してください。
      </Aside>
      ...
      <DocsFooter>Atlas &middot; 情報科学 &middot; 確率・統計と情報理論</DocsFooter>
    </DocsPage>
  );
}
