...
export default function Page() {
  return (
    <DocsPage>
      ...
      <p>実装したモジュールは、その場で<Link href="/sdlc/testing/levels">単体テスト</Link>と組み合わせて確認するのが基本です。実装とテストを近づけるほど、欠陥は早く・安く見つかります。エディタやGitなどの開発環境は<Link href="/dev/workspace">開発環境</Link>や<Link href="/dev/tooling">パッケージ管理とビルド</Link>が担当します。</p>
      ...
      <DocsFooter>Atlas &middot; 開発技術 &middot; 実装</DocsFooter>
    </DocsPage>
  );
}
