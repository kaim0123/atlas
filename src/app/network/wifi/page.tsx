  ...
  return (
    <DocsPage>
      <Hero>
        ...
        <Lead>
          「<Link href="/network/ip">IPアドレスとルーティングの実務</Link>」までは、ケーブルでつながっている前提でIPアドレスの世界を見てきました。ここでは、そのケーブルの代わりに電波を使う<Term>Wi-Fi</Term>が、どうやって機器をネットワークに参加させているのかを見ていきます。
        </Lead>
      </Hero>
      ...
      <p>ハードウェア、有線・IPレベルのネットワーク、そして電波によるWi-Fiまで、コンピュータが「つながる」ための土台を一通り見てきました。それぞれの詳しい通信の中身は「通信プロトコル」で振り返ることができます。</p>
      ...
      <DocsFooter>Atlas &middot; ネットワーク &middot; Wi-Fiの仕組み</DocsFooter>
    </DocsPage>
  );
}
