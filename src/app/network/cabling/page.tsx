  ...
  return (
    <DocsPage>
      <Hero>
        ...
        <h1>ケーブルと規格 ― 地味だが速度の天井を決める</h1>
        <Lead>
          「回線は速いはずなのに、なぜか一部の場所だけ遅い」というトラブルの原因が、実は途中に挟まっている1本の古いLANケーブルだった、ということは珍しくありません。ソフトウェアやサーバーの設定をいくら見直しても、物理的なケーブルの規格がボトルネックになっていれば、そこが速度の天井になってしまいます。
        </Lead>
      </Hero>

      <Heading num="01">LANケーブルの規格 ― Cat(カテゴリ)</Heading>
      ...
      <Heading num="02">RJ45 ― コネクタの形状の名前であって、規格ではない</Heading>
      ...
      <Heading num="03">光ファイバー ― 電気ではなく光で送る</Heading>
      ...
      <Heading num="04">PoE ― ケーブル1本で電力も送る</Heading>
      ...
      <Heading num="05">SFP ― 光ファイバーをつなぐ着脱式の変換モジュール</Heading>
      ...
      <DocsFooter>Atlas &middot; ネットワーク &middot; ケーブルと規格</DocsFooter>
    </DocsPage>
  );
}
