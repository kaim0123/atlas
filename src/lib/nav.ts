  ...
  },
  {
    ...
    tree: [
      { href: "/network/basics", title: "ネットワークの全体像" },
      {
        title: "階層モデル",
        children: [
          { href: "/network/layers", title: "OSI・TCP/IPモデル" },
          { href: "/network/physical", title: "物理層" },
          { href: "/network/link", title: "データリンク層" },
          { href: "/network/link/wireless", title: "無線LAN(Wi-Fi)" },
          { href: "/network/ip", title: "ネットワーク層" },
          { href: "/network/transport", title: "トランスポート層" },
          {
            title: "アプリケーション層",
            children: [
              { href: "/network/applications", title: "概要" },
      ...
      { href: "/network/topology", title: "トポロジと接続装置" },
      {
        title: "インターネット",
        children: [
          { href: "/network/internet", title: "概要" },
